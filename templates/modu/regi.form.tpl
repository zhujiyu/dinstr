    ...
    {if $introUser}
        <div class="dis-intr-user">
            <h3>你的好友<a href="user?id={$introUser.ID}">{$introUser.username}</a>邀请你一起加入{$app.name}</h3>
    ...
    <form class="dis-register-form" action="regi" method="post" title="注册新帐号">
        ...
        <table class="dis-layout-table">
            ...
            <tr class="sign dis-veri-data">
                <td><label for="sign">签&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</label></td>
                <td class="data-td"><input class="dis-login-input" type="text" name="uname" id="sign"></input></td>
                <td class="desc-td"><span class="dis-veri"><span class="dis-icon ui-icon-check"></span></span>
                <label class="dis-desc"></label></td>
            </tr>
        </table>
