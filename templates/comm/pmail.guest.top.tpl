<div class="pm-navi">
    <table class="pm-layout-table pm-navi-content"><tr><td class="pm-navi-logo">
        <a href="guest">{include file="comm/pmail.logo.tpl"}</a>
        ...
        <span class="pm-navi-item">
            <a href="guest?feed">收件</a>
        </span><span class="pm-navi-item">
            <a href="guest?important&period=1d">重点</a>
            <div class="pm-dropdown-menu">
                <a href="guest?important&period=1d">一天</a>|<a href="guest?important&period=3d">三天</a>|<a href="guest?important&period=week">一周</a>|<a href="guest?important&period=month">一月</a>
            </div>
        </span><span class="pm-navi-item">
