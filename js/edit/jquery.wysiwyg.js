...
//			},
			...
			shopping: {
				...
				exec: function () {
					...
					if ($.wysiwyg.controls && $.wysiwyg.controls.shopping) {
						$.wysiwyg.controls.shopping(this);
					} else if ($.wysiwyg.autoload) {
						$.wysiwyg.autoload.control("wysiwyg.shopping.js", function () {
							self.controls.shopping.exec.apply(self);
						});
					} else {
						console.error("$.wysiwyg.controls.shopping not defined. You need to include wysiwyg.shopping.js file");
					}
				},
				tags: ["table"],
				tooltip: "Insert web goods"
			},
...
//			},
		...
		this.defaults = {
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link type="text/css" title="style" href="css/pmail.core.css" rel="stylesheet"/><link type="text/css" title="style" href="css/pmail.wysiwyg.mail.css" rel="stylesheet"/></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
			debug: false,
			controls: {},
			css: {},
			events: {},
...
//							self.ui.toolbar.find("." + controlName).toggleClass("active");
		...
		this.init = function (element, options) {
			...
			$form.bind("reset.wysiwyg", function () { alert(1345); self.resetFunction(); });
		};
